...
class MetaGenerator {
  ...
  #defaultMeta() {
    return [
      {
        tag: "link",
        props: { type: "image/svg+xml", href: "/brand/logo-symbol.svg" },
        content: null,
      },
      {
        tag: "title",
        props: null,
        content: "PandoraLM | Enterprise Hybrid RAG Platform",
      },
      ...
      },
      {
        ...
        props: {
          description: "title",
          content: "PandoraLM | Self-hosted AI platform with Hybrid RAG, GraphRAG, and enterprise security",
        },
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://pandoralm.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://pandoralm.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      { tag: "link", props: { rel: "icon", href: "/brand/logo-symbol.svg" } },
      { tag: "link", props: { rel: "apple-touch-icon", href: "/brand/logo-symbol.svg" } },
  ...
  #validUrl(faviconUrl = null) {
    if (faviconUrl === null) return "/brand/logo-symbol.svg";
    try {
      const url = new URL(faviconUrl);
      return url.toString();
    } catch {
      return "/brand/logo-symbol.svg";
    }
  }
      ...
      this.#customConfig = this.#defaultMeta().map((tag) => {
        ...
        if (tag.tag === "title") {
          return {
            ...
            content:
              customTitle ??
              "PandoraLM | Enterprise Hybrid RAG Platform",
          };
        }
        // Override meta title
  ...
  async generateManifest(response) {
    try {
      ...
      let iconUrl = "/brand/logo-symbol.svg";
      if (faviconURL) {
        try {
          new URL(faviconURL);
          iconUrl = faviconURL;
        } catch {
          iconUrl = "/brand/logo-symbol.svg";
        }
      }
