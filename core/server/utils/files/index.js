...
async function fileData(filePath = null) {
  ...
  // DECOUPLED: If Cortex managed, return a dummy object as Core does not own the data.
  if (filePath.startsWith("cortex://")) {
    return {
      pageContent: "", // No content for Core
      title: "Cortex Document",
      docAuthor: "Cortex",
      description: "Managed by Pandora Cortex",
      source: "cortex",
