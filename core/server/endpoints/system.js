...
function systemEndpoints(app) {
  ...
  app.get(
    ...
    async (_, response) => {
      try {
        // [DECOUPLED] PandoraCore is now stateless. We return an empty list here to prevent
        // the UI from listing "ghost" documents from the local Node.js container storage.
        // Real documents should be fetched via the Cortex API in the future.
        const localFiles = {
          name: "documents",
          type: "folder",
          items: [],
