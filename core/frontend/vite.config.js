...
export default defineConfig({
  ...
  define: {
    ...
    // Pass DEV_MODE_SKIP_AUTH through to frontend for admin console access in staging
    "import.meta.env.VITE_DEV_MODE_SKIP_AUTH": JSON.stringify(process.env.DEV_MODE_SKIP_AUTH || 'false'),
  },
  css: {
    postcss
  },
  ...
  optimizeDeps: {
    include: ["@mintplex-labs/piper-tts-web", "prop-types", "react-beautiful-dnd"],
