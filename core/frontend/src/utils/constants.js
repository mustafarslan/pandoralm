// API Base URL - Points to Core backend (Node.js) which proxies to Cortex
export const API_BASE = "/api";
export const ONBOARDING_SURVEY_URL = "https://onboarding.anythingllm.com";

export const AUTH_USER = "pandoralm_user";
export const AUTH_TOKEN = "pandoralm_authToken";
export const AUTH_TIMESTAMP = "pandoralm_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "pandoralm_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "pandoralm_pinned_document_alert";
export const SEEN_WATCH_ALERT = "pandoralm_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "pandoralm_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "pandoralm_user_prompt_input_map";

export const APPEARANCE_SETTINGS = "pandoralm_appearance_settings";
