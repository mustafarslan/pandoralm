...
import PandoraLMLogo from "./media/logo/pandoralm-light.svg";
import PandoraLMLogoDark from "./media/logo/pandoralm-dark.svg";
  ...
  async function fetchInstanceLogo() {
    try {
      ...
      if (logoURL) {
        ...
        localStorage.getItem("theme") !== "default"
          ? setLogo(PandoraLMLogoDark)
          : setLogo(PandoraLMLogo);
