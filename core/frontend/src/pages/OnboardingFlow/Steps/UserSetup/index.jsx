...
export default function UserSetup({ setHeader, setForwardBtn, setBackBtn }) {
  ...
  return (
    <div className="w-full flex items-center justify-center flex-col gap-y-6">
      <div className="flex flex-col border rounded-lg border-[#7D7D7D] bg-white p-8 items-center gap-y-4 w-full max-w-[600px]">
        <div className=" text-[#252525] text-sm font-semibold md:-ml-44">
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
          <button
            ...
            className={`${selectedOption === "just_me"
                ? "bg-[#E5E5E5] border-[#252525] text-[#252525]"
                : "bg-white border-[#7D7D7D] text-[#7D7D7D]"
              } min-w-[230px] h-11 p-4 rounded-[10px] border-2  justify-center items-center gap-[100px] inline-flex hover:bg-[#E5E5E5] transition-all duration-300`}
          >
...
const JustMe = ({
  ...
  return (
    <div className="w-full flex items-center justify-center flex-col gap-y-6">
      <div className="flex flex-col border rounded-lg border-[#7D7D7D] bg-white p-8 items-center gap-y-4 w-full max-w-[600px]">
        <div className=" text-[#252525] text-sm font-semibold md:-ml-56">
        ...
        {enablePassword && (
          <form className="w-full mt-4" onSubmit={handleSubmit}>
            <label
              htmlFor="name"
              className="block mb-3 text-sm font-medium text-[#252525]"
            >
            ...
            <input
              name="password"
              type="password"
              className="bg-white text-[#252525] text-sm rounded-lg block w-full p-2.5 outline-none placeholder:text-[#7D7D7D]"
            ...
            />
            <div className="mt-4 text-[#545454] text-xs font-base -mb-2">
...
const MyTeam = ({ setMultiUserLoginValid, myTeamSubmitRef, navigate }) => {
  ...
  return (
    <div className="w-full flex items-center justify-center border max-w-[600px] rounded-lg border-[#7D7D7D] bg-white">
        ...
        <div className="flex flex-col w-full md:px-8 px-2 py-4">
          <div className="space-y-6 flex h-full w-full">
            <div className="w-full flex flex-col gap-y-4">
              ...
              <p className=" text-[#545454] text-xs font-base">
