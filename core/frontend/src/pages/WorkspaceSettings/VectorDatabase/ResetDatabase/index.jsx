...
export default function ResetDatabase({ workspace }) {
  ...
  return (
    <button
      ...
      type="button"
      className="w-60 transition-all duration-300 border border-red-200 rounded-lg whitespace-nowrap text-sm px-5 py-2.5 focus:z-10 bg-white text-red-600 hover:bg-red-50 hover:border-red-400 disabled:bg-gray-100 disabled:text-gray-400"
    >
      {deleting
