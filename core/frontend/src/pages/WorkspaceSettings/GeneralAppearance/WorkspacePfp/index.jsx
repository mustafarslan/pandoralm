    ...
    <div className="mt-6">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8">
        <div className="flex flex-col items-center">
          <label className="w-36 h-36 flex flex-col items-center justify-center bg-theme-settings-input-bg transition-all duration-300 rounded-full mt-8 border-2 border-dashed border-[#7D7D7D] border-opacity-60 cursor-pointer hover:opacity-60">
            <input
