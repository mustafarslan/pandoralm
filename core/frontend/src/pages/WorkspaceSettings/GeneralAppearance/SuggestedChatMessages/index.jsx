    ...
    <div className="w-full mt-6">
        ...
        {suggestedMessages.map((suggestion, index) => (
          <div key={index} className="relative w-full">
            ...
            <button
              ...
              className={`text-left p-2.5 border rounded-xl w-full border-white/20 bg-theme-settings-input-bg hover:bg-theme-sidebar-item-selected-gradient ${editingIndex === index ? "border-sky-400" : ""
                }`}
            >
      ...
      {suggestedMessages.length < 4 && (
        <button
          type="button"
          onClick={addMessage}
          className="flex gap-x-2 items-center justify-center mt-6 text-[#252525] text-sm hover:text-sky-400 transition-all duration-300"
        >
