    ...
    <>
      ...
      <div>
        ...
        <div className="flex flex-col">
          ...
          <p className="text-[#545454] text-xs font-medium mb-2">
            You can insert{" "}
            <Link
            ...
            {availableVariables.slice(0, 3).map((v, i) => (
              <Fragment key={v.key}>
                <span className="bg-[#E5E7EB] text-[#252525] px-1 py-0.5 rounded">
                  {`{${v.key}}`}
                </span>
        ...
        <div className="relative w-full flex flex-col items-end">
          <button
            ...
            type="button"
            className="text-[#545454] hover:text-[#252525] text-xs font-medium"
            onClick={(e) => {
              e.preventDefault();
          ...
          <div className="relative w-full">
            {isEditing ? (
              <textarea
                ...
                defaultValue={prompt}
                className="border border-[#545454] bg-white text-[#252525] text-sm rounded-lg focus:outline-none block w-full p-2.5 mt-2"
              />
            ) : (
              <div
