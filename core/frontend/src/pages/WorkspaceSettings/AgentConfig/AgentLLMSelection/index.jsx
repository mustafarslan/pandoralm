            ...
            <div className="w-full flex flex-col gap-y-1">
              <div className="flex items-center sticky top-0 z-10 border-b border-[#CFCFCF] mx-4 bg-white">
                ...
                <input
                  ...
                  className="border-none -ml-4 my-2 bg-transparent z-20 pl-12 h-[38px] w-full px-4 py-1 text-sm outline-none text-[#252525] placeholder:text-[#7D7D7D] placeholder:font-medium"
