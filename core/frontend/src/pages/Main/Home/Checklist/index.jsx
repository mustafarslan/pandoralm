...
export default function Checklist() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`rounded-xl p-6 bg-white border border-ink-border/10 shadow-sm relative ${isCompleted ? "blur-sm" : ""}`}
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-x-3">
            <h1 className="text-ink-heading uppercase text-sm font-bold tracking-widest">
          ...
          <div className="flex items-center gap-x-2">
            <button
              onClick={handleClose}
              className="text-ink-muted bg-ink-page border border-ink-border/10 px-3 py-1 rounded-lg hover:bg-ink-panel transition-colors text-xs font-medium"
            >
