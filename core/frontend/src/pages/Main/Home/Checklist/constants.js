...
export const CHECKLIST_UPDATED_EVENT = "pandoralm_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "pandoralm_checklist_completed";
export const CHECKLIST_HIDDEN = "pandoralm_checklist_dismissed";
