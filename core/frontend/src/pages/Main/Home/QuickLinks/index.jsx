...
export default function QuickLinks() {
  ...
  return (
    <div>
      <h1 className="text-ink-muted uppercase text-sm font-semibold mb-4 tracking-widest">
        {t("main-page.quickLinks.title")}
      </h1>
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <button
          onClick={sendChat}
          className="h-[45px] text-sm font-semibold bg-white border border-ink-border/20 text-ink-primary rounded-lg flex items-center justify-center gap-x-2.5 transition-all duration-200 hover:border-ink-action/50 hover:shadow-sm"
        >
          <ChatCenteredDots size={16} className="text-ink-heading" />
        ...
        <button
          ...
          className="h-[45px] text-sm font-semibold bg-white border border-ink-border/20 text-ink-primary rounded-lg flex items-center justify-center gap-x-2.5 transition-all duration-200 hover:border-ink-action/50 hover:shadow-sm"
        >
          <FileArrowDown size={16} className="text-ink-heading" />
        ...
        <button
          ...
          className="h-[45px] text-sm font-semibold bg-white border border-ink-border/20 text-ink-primary rounded-lg flex items-center justify-center gap-x-2.5 transition-all duration-200 hover:border-ink-action/50 hover:shadow-sm"
        >
          <Plus size={16} className="text-ink-heading" />
