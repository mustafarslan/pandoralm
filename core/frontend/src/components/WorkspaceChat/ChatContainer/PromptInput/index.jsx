...
export default function PromptInput({
  ...
  // Glass Box state - for System 2 pulse animation
  const glassBox = useGlassBoxSafe();
  const isSystem2Active = glassBox?.isThinking && glassBox?.currentTier === 'SYSTEM_2';
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-white via-white/80 to-transparent z-10">
      <div className="mx-auto max-w-3xl w-full">
        ...
        <form
          ...
          className="flex flex-col gap-y-1 w-full max-w-[800px] mx-auto items-center"
        >
          <div className={`w-full bg-white border border-[#E5E5E5] shadow-sm rounded-2xl flex flex-col px-2 overflow-hidden transition-all duration-300 ${isSystem2Active ? 'ring-2 ring-violet-500/50 shadow-[0_0_20px_rgba(139,92,246,0.3)] animate-pulse-slow' : ''}`}>
            ...
            <div className="flex items-center mx-3">
              <textarea
                ...
                className={`border-none ring-0 focus:ring-0 cursor-text max-h-[50vh] md:max-h-[350px] md:min-h-[40px] mx-2 md:mx-0 pt-[12px] w-full leading-5 text-[#252525] bg-transparent placeholder:text-gray-400 light:placeholder:text-gray-500 resize-none active:outline-none focus:outline-none flex-grow mb-1 pwa:!text-[16px] ${textSizeClass}`}
              ...
              {isStreaming ? (
                ...
                <>
                  ...
                  >
                    <PaperPlaneRight
                      color="#252525"
                      className="w-[22px] h-[22px] pointer-events-none text-[#252525] group-disabled:opacity-[25%]"
                      weight="fill"
                    />
