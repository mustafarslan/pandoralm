      ...
      <div className="px-8 pb-8" onContextMenu={handleContextMenu}>
        <div className="flex flex-col gap-y-6">
          <div className="flex items-center justify-between w-[560px] px-5 relative">
            <h3 className="text-[#252525] text-base font-bold">
            ...
            <div className="relative">
              <input
                ...
                className="border border-[#545454] search-input bg-[#FFFFFF] text-[#252525] placeholder:text-[#7D7D7D] focus:outline-none focus:border-[#252525] text-sm rounded-lg pl-9 pr-2.5 py-2 w-[250px] h-[32px]"
              />
              <MagnifyingGlass
                size={14}
                className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#252525]"
                weight="bold"
              />
            </div>
            <button
              className="border-none flex items-center gap-x-2 cursor-pointer px-[14px] py-[7px] -mr-[14px] rounded-lg hover:bg-[#E5E5E5] z-20 relative transition-colors"
            ...
            >
              ...
              />
              <div className="text-[#252525] text-xs font-bold leading-[18px]">
                {t("connectors.directory.new-folder")}
              </div>
            </button>
          </div>

          <div className="relative w-[560px] h-[310px] bg-[#FAFAFA] rounded-2xl overflow-hidden border border-[#545454]">
            <div className="absolute top-0 left-0 right-0 z-10 rounded-t-2xl text-[#252525] text-xs grid grid-cols-12 py-2 px-8 border-b border-[#545454] bg-[#FAFAFA]">
            ...
            <div className="overflow-y-auto h-full pt-8">
              {loading ? (
                <div className="w-full h-full flex items-center justify-center flex-col gap-y-5">
                  <PreLoader />
                  <p className="text-[#252525] text-sm font-semibold animate-pulse text-center w-1/3">
                    {loadingMessage}
                  </p>
                </div>
            ...
            {amountSelected !== 0 && (
              <div className="absolute bottom-[12px] left-0 right-0 flex justify-center pointer-events-none">
                <div className="mx-auto bg-[#FFFFFF] rounded-lg py-1 px-2 pointer-events-auto shadow-md border border-[#545454]">
                  <div className="flex flex-row items-center gap-x-2">
                    <button
                      onClick={moveToWorkspace}
                      onMouseEnter={() => setHighlightWorkspace(true)}
                      onMouseLeave={() => setHighlightWorkspace(false)}
                      className="border-none text-sm font-semibold bg-[#FFFFFF] h-[30px] px-2.5 rounded-lg text-[#252525] hover:bg-[#E5E5E5] transition-colors"
                    >
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="border-none text-sm font-semibold bg-[#FFFFFF] h-[32px] w-[32px] rounded-lg text-[#252525] hover:bg-[#E5E5E5] transition-colors flex justify-center items-center group"
                      >
                        <MoveToFolderIcon className="text-[#252525]" />
                      </button>
                      {showFolderSelection && (
                    ...
                    <button
                      onClick={deleteFiles}
                      className="border-none text-sm font-semibold bg-[#FFFFFF] h-[32px] w-[32px] rounded-lg text-[#252525] hover:bg-[#E5E5E5] transition-colors flex justify-center items-center"
                    >
