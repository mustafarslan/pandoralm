    ...
    return (
      <div className="px-8">
        <div className="flex items-center justify-start w-[560px]">
          <h3 className="text-[#252525] text-base font-bold ml-5">
            {workspace.name}
          </h3>
        </div>
        <div className="relative w-[560px] h-[445px] bg-[#FAFAFA] rounded-2xl mt-5 border border-[#545454]">
          <div className="text-[#252525] text-xs grid grid-cols-12 py-2 px-3.5 border-b border-[#545454] bg-[#FAFAFA] sticky top-0 z-10 rounded-t-2xl">
            <div className="col-span-10 flex items-center gap-x-[4px]">
              <div className="shrink-0 w-3 h-3" />
              <p className="ml-[7px] text-[#252525]">Name</p>
            </div>
    ...
    <>
      <div className="px-8">
        ...
        <div className="relative w-[560px] h-[445px] mt-5">
          ...
          />
          <div className="relative w-full h-full bg-[#FAFAFA] rounded-2xl overflow-hidden border border-[#545454]">
            <div className="text-[#252525] text-xs grid grid-cols-12 py-2 px-3.5 border-b border-[#545454] bg-[#FAFAFA] sticky top-0 z-10">
              <div className="col-span-10 flex items-center gap-x-[4px]">
                {!hasChanges &&
                  files.items.some((folder) => folder.items.length > 0) ? (
                  <div
                    className={`shrink-0 w-3 h-3 rounded border-[1px] border-solid border-[#545454] text-[#252525] flex justify-center items-center cursor-pointer`}
                    role="checkbox"
                    aria-checked={
