...
export default function WorkspaceFileRow({
  ...
  return (
    <div
      className={`text-[#252525] text-xs grid grid-cols-12 py-2 pl-3.5 pr-8 h-[34px] items-center file-row ${!disableSelection
          ? "hover:bg-[#E5E5E5] cursor-pointer"
          : ""
        } ${isMovedItem ? "selected bg-[#E5E5E5]" : ""} ${selected ? "selected bg-[#E5E5E5]" : ""
        }`}
    ...
    >
      ...
      >
        ...
        <File
          className="shrink-0 text-base font-bold w-4 h-4 mr-[3px] ml-1 text-[#252525]"
          weight="fill"
        />
