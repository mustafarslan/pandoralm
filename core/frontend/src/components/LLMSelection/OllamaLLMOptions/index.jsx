    ...
    <div className="w-full flex flex-col gap-y-7">
      ...
      <div hidden={!showAdvancedControls}>
        <div className="flex flex-col">
          {/* Advanced Settings Row: Base URL, Performance, Keep Alive */}
          {/* Used Grid for strict column alignment */}
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4">

            {/* Column 1: Base URL */}
            <div className="flex flex-col">
              {/* Label Container - Strict Height 24px + mb-2 = Consistent Top Alignment */}
              <div className="flex justify-between items-center mb-2 h-[24px]">
              ...
              <input
                ...
                className="border-none bg-theme-settings-input-bg text-white placeholder:text-theme-settings-input-placeholder text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5 h-[42px]"
            ...
            {/* Column 2: Performance Mode */}
            <div className="flex flex-col">
              <div className="flex items-center mb-2 h-[24px]">
                <label className="text-white text-sm font-semibold flex items-center cursor-pointer">
                  Performance Mode
                  <Info
                    size={16}
              ...
              <select
                ...
                required={true}
                className="border-none bg-theme-settings-input-bg border-gray-500 text-white text-sm rounded-lg block w-full p-2.5 h-[42px]"
