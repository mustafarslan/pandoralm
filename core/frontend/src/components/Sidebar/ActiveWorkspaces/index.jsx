                      ...
                      <div className="flex gap-x-2 items-center justify-between">
                        <div
                          ...
                          className={`
                            ...
                            flex flex-grow w-[75%] gap-x-2 px-3 py-2.5 rounded-lg justify-between items-center
                            border-2 cursor-pointer
                            ${isActive
                              ? "bg-white border-[#252525] border-l-4 text-[#252525] font-bold shadow-sm"
                              : "bg-white border-[#CFCFCF] text-[#545454] font-semibold hover:border-[#7D7D7D] hover:text-[#252525]"
                            }
                          `}
                        >
                          <div className="flex flex-row justify-between w-full items-center">
                            <div
                              ...
                              className="cursor-grab mr-[3px] text-[#7D7D7D] group-hover:text-[#545454]"
                            >
                              <DotsSixVertical
                                size={20}
                                weight="bold"
                              ...
                              <div className="w-[130px] overflow-hidden">
                                <p
                                  className={`
                                    ...
                                    font-medium truncate w-full duration-200
                                  `}
                                >
                                  {workspace.name}
                                </p>
