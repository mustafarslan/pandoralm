  ...
  return (
    <Layout>
      <div className="w-full h-full flex flex-col items-center justify-center overflow-y-auto no-scroll">
        ...
        />
        <h1 className="text-[var(--ink-heading)] text-3xl font-extrabold tracking-tight">
          {t("home.welcome")}, {user.username}!
        </h1>
        <p className="text-[var(--ink-body)] text-base font-medium text-center whitespace-pre-line leading-relaxed">
...
const Layout = ({ children }) => {
  ...
  return (
    <div
      ...
      className={`relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] w-full h-full overflow-y-scroll ${showScrollbar ? "show-scrollbar" : "no-scroll"}`}
    >
      {children}
    </div>
  );
