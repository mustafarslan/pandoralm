...
export default function AccountModal({ user, hideModal }) {
  ...
  return (
    <ModalWrapper isOpen={true}>
      <div className="w-full max-w-2xl bg-[#CFCFCF] rounded-lg shadow-xl border-2 border-[#545454] overflow-hidden">
        <div className="relative p-6 border-b rounded-t border-[#545454]">
          ...
          <button
            onClick={hideModal}
            type="button"
            className="absolute top-4 right-4 transition-all duration-300 bg-transparent rounded-lg text-sm p-1 inline-flex items-center hover:bg-[#545454]/10 hover:border-[#545454] hover:border-opacity-50 border-transparent border"
          >
            <X size={24} weight="bold" className="text-[#252525]" />
          </button>
        </div>
        <div
          ...
          <form onSubmit={handleUpdate} className="space-y-6">
            ...
            <div className="flex flex-col gap-y-4 px-6">
              <div>
                <label
                  htmlFor="username"
                  className="block mb-2 text-sm font-medium text-[#252525]"
                >
                ...
                <input
                  ...
                  className="border border-[#545454] bg-white placeholder:text-[#7D7D7D] text-[#252525] text-sm rounded-lg focus:outline-none block w-full p-2.5"
              ...
              <div>
                ...
                <textarea
                  name="bio"
                  className="border border-[#545454] bg-white placeholder:text-[#7D7D7D] text-[#252525] text-sm rounded-lg focus:outline-none block w-full p-2.5 min-h-[100px] resize-y"
            ...
            <div className="flex justify-between items-center border-t border-[#545454] pt-4 p-6">
              <button
                onClick={hideModal}
                type="button"
                className="transition-all duration-300 text-[#252525] hover:bg-white border border-transparent hover:border-[#545454] px-4 py-2 rounded-lg text-sm"
              >
                {t("profile_settings.cancel")}
              </button>
              <button
                type="submit"
                className="transition-all duration-300 bg-[#252525] text-white hover:bg-[#545454] border border-[#252525] px-4 py-2 rounded-lg text-sm"
              >
...
function LanguagePreference() {
  ...
  return (
    <div>
      ...
      <select
        name="userLang"
        className="border border-[#545454] bg-white text-[#252525] w-fit mt-2 px-4 focus:outline-none text-sm rounded-lg block py-2"
  ...
  return (
    <div>
      ...
      <select
        ...
        className="border border-[#545454] bg-white text-[#252525] w-fit px-4 focus:outline-none text-sm rounded-lg block py-2"
      >
  ...
  return (
    <div>
      <div className="flex items-center gap-x-1 mb-2">
        <label
          htmlFor="autoSubmit"
          className="block text-sm font-medium text-[#252525]"
        >
        ...
        >
          <Info size={16} weight="bold" className="text-[#252525]" />
        </div>
      </div>
