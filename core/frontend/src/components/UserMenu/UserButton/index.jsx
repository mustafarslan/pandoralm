  ...
  return (
    <div className="absolute top-3 right-4 md:top-9 md:right-10 w-fit h-fit z-40">
      <button
        ...
        type="button"
        className="uppercase transition-all duration-300 w-[35px] h-[35px] text-base font-semibold rounded-full flex items-center justify-center p-2 border shadow-md"
        style={{
      ...
      {showMenu && (
        <div
          ref={menuRef}
          className="w-fit rounded-lg absolute top-12 right-0 p-2 flex items-center-justify-center shadow-lg border"
          style={{
            backgroundColor: "#252525",
            borderColor: "#545454",
          }}
          ...
          <div className="flex flex-col gap-y-2">
            {mode === "multi" && !!user && (
              <button
                ...
                className="border-none w-full text-left px-4 py-1.5 rounded-md transition-colors duration-200"
                style={{ color: "#CFCFCF" }}
                onMouseEnter={(e) => (e.target.style.backgroundColor = "#545454")}
            ...
            <a
              href={supportEmail}
              className="w-full text-left px-4 py-1.5 rounded-md transition-colors duration-200"
              style={{ color: "#CFCFCF" }}
              onMouseEnter={(e) => (e.target.style.backgroundColor = "#545454")}
              onMouseLeave={(e) => (e.target.style.backgroundColor = "transparent")}
            >
